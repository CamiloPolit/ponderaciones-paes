...
women_percentage = pd.read_csv('/content/drive/MyDrive/bbdd/PORCENTAJE_MUJERES_CARRERAS.csv')
...
merged_df = pd.merge(merged_df, requirements_table, left_on='CODIGO_CARRERA', right_on='COD_CARRERA', how='inner')
merged_df = pd.merge(merged_df, women_percentage, left_on='CODIGO_CARRERA', right_on='codigo_demre', how='inner')
