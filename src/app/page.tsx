    ...
    <div className="flex min-h-[100dvh] flex-col">
      ...
      <footer className="bg-black px-7 py-12">
        ...
        <p className="text-center text-xs leading-7 text-stone-400">
          Quiero agradecer a Benjamín Henríquez por el constante apoyo y
          feedbacks en la creación de esta página, además de Felipe Córdova por
          su ayuda en la obtención de datos de sedes de universidades.
        </p>
