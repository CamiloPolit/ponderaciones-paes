...
columns = ["MRUN", "RBD", "NOMBRE_UNIDAD_EDUC", "DEPENDENCIA", "NOMBRE_COMUNA_EGRESO", "PROMEDIO_NOTAS", "PTJE_NEM", "PTJE_RANKING", "CLEC_MAX", "MATE1_MAX", "MATE2_MAX", "HCSOC_MAX", "CIEN_MAX"]

# Importamos también el csv con los alumnos matriculados en las universidades, para filtrar a los que no se matricularon
students_info = pd.read_csv("/content/drive/MyDrive/PAES-2024-Inscritos-Puntajes/A_INSCRITOS_PUNTAJES_PAES_2024_PUB_MRUN.csv", sep=";", usecols=columns)
...
print(merged_university_students_info)
